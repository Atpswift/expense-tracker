document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('clear-budgets').addEventListener('click', () => {
        // Clear the localStorage for budgets
        localStorage.removeItem('budgets');

        // Reset the budgets array
        budgets = [];

        // Clear the budget list in the UI
        budgetList.innerHTML = '';
        totalBudget = 0;

        // Provide feedback to the user
        alert('All budgets have been cleared.');
    });
